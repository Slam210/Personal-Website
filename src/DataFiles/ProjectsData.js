        ...
        Project: [
            {
                ...
                ImageLinks: [
                    '/src/Images/Chess/Chess1.png',
                    '/src/Images/Chess/Chess2.png',
                    '/src/Images/Chess/Chess3.png',
                    '/src/Images/Chess/Chess4.png',
                    '/src/Images/Chess/Chess5.png',
                ],
            },
            {
                ...
                ImageLinks: [
                    '/src/Images/ABP/ABP1.png',
                    '/src/Images/ABP/ABP2.png',
                    '/src/Images/ABP/ABP3.png',
                    '/src/Images/ABP/ABP4.png',
                    '/src/Images/ABP/ABP5.png',
                ],
            },
            {
                ...
                ImageLinks: [
                    '/src/Images/ShapeShift/SS1.png',
                    '/src/Images/ShapeShift/SS2.png',
                    '/src/Images/ShapeShift/SS3.png',
                    '/src/Images/ShapeShift/SS4.png',
                    '/src/Images/ShapeShift/SS5.png',
                    '/src/Images/ShapeShift/SS6.png',
                    '/src/Images/ShapeShift/SS7.png',
                ],
            },
            {
                ...
                ImageLinks: [
                    '/src/Images/JavaScript/BlackJack.png',
                    '/src/Images/JavaScript/Tracker.png',
                    '/src/Images/JavaScript/Calc.png',
                ],
            },
            {
                Title: 'React',
                ...
                ImageLinks: [
                    '/src/Images/React/MemeGenerator.png',
                    '/src/Images/React/Notes.png',
                    '/src/Images/React/Tenzies.png',
                ],
            },
        ],
    },
